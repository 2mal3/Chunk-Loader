...
dir core {
    function load {
        ...
        execute unless score %installed chlo.data matches 1 run function chlo:core/install
        execute if score %installed chlo.data matches 1 unless score $version chlo.data matches <%config.version.int%> run function chlo:core/update
    }
    ...
    function install {
        ...
        schedule 4s replace {
            tellraw @a [{"text":"Chunk Loader <%config.version.str%> by 2mal3 was installed!","color":"green"}]
        }
    }
    ...
    advancement chlo {
        "display": {
        "title": "Chunk Loader <%config.version.str%>",
    ...
    function first_join {
        ...
        execute unless score .temp0 chlo.data matches 3105.. run tellraw @s [{"text":"[","color":"gray"},{"text":"ChunkLoader","color":"gold"},{"text":"/","color":"gray"},{"text":"WARN","color":"gold"},{"text": "/","color": "gray"},{"text": "Server","color": "gold"},{"text":"]: ","color":"gray"},{"text":"This Minecraft version is not supported by the datapack. Please use the 1.19 or a later one to prevent errors.","color":"gold"}]
    }
    ...
    function uninstall {
        ...
        tellraw @a [{"text":"Chunk Loader <%config.version.str%> by 2mal3 was successfully uninstalled.","color": "green"}]
